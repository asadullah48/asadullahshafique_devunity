...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {/* `end-4`, not `right-4`: dialog headers are start-aligned, so on the
          RTL /ar route a physically-right button lands on top of the title.
          Resolves identically to right-4 in LTR. */}
