          ...
          <footer className="border-t border-zinc-800 bg-zinc-950">
                <div className="container mx-auto px-4 py-12">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                          {/* Brand */}
                                  <div>
                                              <h3 className="text-xl font-bold text-white mb-3">
                                                            Asadullah <span className="text-[#9CE630]">Shafique</span>span>
                                              </h3>h3>
                          ...
                          {/* Quick Links */}
                                  <div>
                                              <h3 className="text-lg font-semibold text-white mb-4">Quick Links</h3>h3>
            ...
            { name: "Open Source", href: "#opensource" },
                          ...
                          {/* Contact */}
                                  <div>
                                              <h3 className="text-lg font-semibold text-white mb-4">Get in Touch</h3>h3>
