        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-foreground mb-3">
              Asadullah <span className="text-brand">Shafique</span>
            </h3>
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              {t("footer.bio")}
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="https://github.com/asadullah48" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-brand transition-colors">
                <Github className="h-5 w-5" />
              </Link>
              <Link href="https://www.linkedin.com/in/asadullah-shafique-a00679325/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-brand transition-colors">
                <Linkedin className="h-5 w-5" />
              </Link>
              <Link href="https://x.com/texcotembroide1" target="_blank" rel="noopener noreferrer" aria-label="Twitter / X" className="text-muted-foreground hover:text-brand transition-colors">
                <Twitter className="h-5 w-5" />
              </Link>
              <Link href="mailto:asadullahshafique@hotmail.com" aria-label="Email" className="text-muted-foreground hover:text-brand transition-colors">
                <Mail className="h-5 w-5" />
              </Link>
              <Link href="https://facebook.com/asadullahshafique" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted-foreground hover:text-brand transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
              </Link>
              <Link href="https://instagram.com/shafiqueasadullah" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-brand transition-colors">
              ...
              <Link href="https://medium.com/@texcotembroiderysourcinghouse" target="_blank" rel="noopener noreferrer" aria-label="Medium" className="text-muted-foreground hover:text-brand transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              <Link href="https://discord.gg/kXfEYVGX" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-muted-foreground hover:text-brand transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">{t("footer.quickLinksTitle")}</h3>
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-muted-foreground hover:text-brand text-sm transition-colors">
                    {t(link.nameKey)}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">{t("footer.getInTouchTitle")}</h3>
