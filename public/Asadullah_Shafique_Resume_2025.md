...
[GitHub](https://github.com/asadullah48) | [LinkedIn](https://linkedin.com) | [Portfolio](https://asadullahshafique-devunity.vercel.app) | [Medium](https://medium.com/@texcotembroiderysourcinghouse)

---

## PROFESSIONAL SUMMARY

Agentic AI Developer and CMT Industry Founder with 25+ years of deep textile domain expertise, now building AI-powered SaaS for Pakistan's textile value chain. Founder of Texcot Embroidery Sourcing House and creator of the **Textile ERP Platform** — a full-scale system targeting fabric mills, CMT units, and garment exporters across Faisalabad, Sialkot, Gujranwala, Karachi, and Lahore.
...
### Textile ERP Platform — Pakistan *(In Development)*
...
- Two-tier architecture: General Agent (Claude Code) manufactures Custom Agent (OpenAI Agents SDK)
